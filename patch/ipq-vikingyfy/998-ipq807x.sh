...
sed -i '$a https://mirrors.pku.edu.cn/immortalwrt/snapshots/targets/qualcommax/ipq807x/kmods/6.6.77-1-750dd8effa34f99140df2bf38b237251/packages.adb' /etc/apk/repositories.d/customfeeds.list
